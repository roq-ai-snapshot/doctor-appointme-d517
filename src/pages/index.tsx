  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Doctor Appointment System v1, where scheduling your next medical appointment is simplified, efficient, and just a click away."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Doctor Appointment System v1, where scheduling your next medical appointment is simplified, efficient, and just a click away.`}
            </Text>
            <Box
